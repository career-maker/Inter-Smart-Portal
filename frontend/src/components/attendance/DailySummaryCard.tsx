...
export function DailySummaryCard({
  ...
  return (
    <Card className="shadow-sm border-white/10 bg-slate-800/50 backdrop-blur-sm text-white mb-6">
      ...
      <CardContent className="pt-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-700/30 rounded-lg p-4">
            <p className="text-xs text-slate-400 mb-1">First Check-In</p>
          ...
          {/* Total Working Hours */}
          <div className="bg-slate-700/30 rounded-lg p-4">
            <p className="text-xs text-slate-400 mb-1">Total Worked</p>
