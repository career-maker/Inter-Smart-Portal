...
export function AttendanceWidget({ initialData }: { initialData?: any }) {
  ...
  if (isLoading) {
    return <div className="bg-white dark:bg-[#182433] border border-slate-200 dark:border-slate-700/60 rounded-3xl p-6 shadow-sm animate-pulse h-48 mb-6"></div>;
  }
  ...
  return (
    <div className="bg-white dark:bg-[#182433] border border-slate-200 dark:border-slate-700/60 rounded-3xl p-5 md:p-6 shadow-sm mb-6 relative overflow-hidden group">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-6 relative z-10">
        ...
        <div className="flex-1 w-full">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {/* Punch In */}
            <div className="bg-white dark:bg-[#182433] rounded-2xl p-4 text-center shadow-sm border border-emerald-500/25">
            ...
            {/* Punch Out */}
            <div className="bg-white dark:bg-[#182433] rounded-2xl p-4 text-center shadow-sm border border-rose-500/25">
            ...
            {/* Total Break */}
            <div className="bg-white dark:bg-[#182433] rounded-2xl p-4 text-center shadow-sm border border-amber-500/25">
            ...
            {/* Worked Time */}
            <div className="bg-white dark:bg-[#182433] rounded-2xl p-4 text-center shadow-sm border border-cyan-500/25">
