    ...
    <Portal>
      <div className="fixed inset-0 z-[99999] overflow-hidden font-sans" data-side-popup="true">
        ...
        <div
          ...
          className="fixed inset-y-0 right-0 max-w-xl sm:max-w-2xl w-full bg-white dark:bg-slate-900 shadow-2xl flex flex-col justify-between border-l border-slate-200 dark:border-slate-800 z-[99999] animate-in slide-in-from-right duration-300"
        >
          {/* Modal Header */}
        ...
        {/* Modal Footer */}
        <div className="flex flex-wrap items-center justify-between gap-3 p-4 px-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 shrink-0">
          <div>
            {canManage && (
              <>
                {showDeleteConfirm ? (
