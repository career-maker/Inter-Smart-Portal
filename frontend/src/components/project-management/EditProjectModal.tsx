      ...
      <div className="fixed inset-0 z-[99999] overflow-hidden font-sans" data-side-popup="true">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <SearchableCoordinatorSelect
                ...
                initialCoordinator={project.coordinator}
        ...
        <div className="flex items-center justify-end gap-3 p-4 px-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 shrink-0">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs sm:text-sm font-semibold shadow-sm shadow-blue-500/20 transition-colors disabled:opacity-50 cursor-pointer"
          >
            {submitting ? (
              <>
