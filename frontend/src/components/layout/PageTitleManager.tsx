...
const ROUTE_NAME_MAP: Record<string, string> = {
  ...
  "/project-management/bugsmart": "bugSmart",
  "/project-management/bugsmart/overview": "bugSmart Overview",
  "/project-management/bugsmart/bugs": "bugSmart Bugs",
  "/project-management/bugsmart/bugs/new": "Report Defect - bugSmart",
  "/project-management/bugsmart/projects": "bugSmart Projects",
  "/project-management/bugsmart/reports": "bugSmart Reports",
  "/project-management/bugsmart/saved-searches": "bugSmart Saved Searches",
  "/project-management/bugsmart/permissions": "bugSmart Team Permissions",
