    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="bg-white/10 border border-slate-200 dark:border-white/20 rounded-lg p-1 flex shadow-sm">
            <button
          ...
          <Button onClick={(e) => { e.stopPropagation(); handleMarkAllAsRead(); }} variant="outline" size="sm" className="h-9 gap-2 border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5">
      ...
      <Card className="shadow-sm border-slate-200 dark:border-white/10 bg-white/5">
        <CardHeader className="pb-4 border-b border-slate-200 dark:border-white/10">
          <CardTitle className="text-lg flex items-center gap-2">
            <Bell className="h-5 w-5 text-amber-400" />
            History
          </CardTitle>
          <CardDescription className="text-slate-500 dark:text-slate-400">A timeline of all your notifications</CardDescription>
        </CardHeader>
