...
export default function ManageLeavesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Manage Approved Leaves & WFH</h1>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full mt-1 px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded text-slate-900 dark:text-white text-sm"
            >
