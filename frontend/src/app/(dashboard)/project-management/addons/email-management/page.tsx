...
export default function EmailManagementPage() {
  ...
  return (
    ...
    >
      ...
      {/* ── Override Drawer / Modal ── */}
      {isOverrideModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn">
          <div className="w-full max-w-lg rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl p-6 space-y-5 animate-scaleUp">
            <div className="flex items-start justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
              <div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white">
                  {editingIndex !== null ? "Edit Employee Override" : "New Employee Email Override"}
                </h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            ...
            <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-[#56348f] hover:bg-[#462875] text-white text-xs font-bold shadow-md transition-all cursor-pointer"
              >
