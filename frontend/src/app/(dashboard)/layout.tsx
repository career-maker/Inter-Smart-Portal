    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      {menuOpen && (
        <>
          ...
          <div role="navigation" className="fixed top-20 right-4 w-72 max-h-[calc(100vh-7rem)] bg-slate-900 border border-white/10 rounded-2xl shadow-2xl z-[9999] overflow-y-auto">
