...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!isHydrated) {
    return (
      <div className="fixed inset-0 flex flex-col overflow-hidden z-[9999]" style={{ backgroundColor: '#F8FAFC' }}>
        <div className="h-16 border-b border-slate-200" style={{ backgroundColor: '#F8FAFC' }} />
