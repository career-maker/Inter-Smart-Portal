...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/holidays",         label: "Holiday Calendar", roles: ["Super Admin"] },
...
function isItemVisible(item: NavItem, role: string, permissions: Record<string, boolean> = {}) {
  if (item.href === "/project-management/bugzilla") {
    if (role === "Super Admin") return true;
    return Boolean(
      permissions.bugzilla_viewer ||
      permissions.bugzilla_reporter ||
      permissions.bugzilla_developer
    );
  }
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-background flex">
      ...
      {/* Mobile/Tablet: Add to Home Screen bottom sheet matching native iOS/Android style */}
