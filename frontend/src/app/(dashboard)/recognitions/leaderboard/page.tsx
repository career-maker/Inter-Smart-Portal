...
function PhotoAvatar({ src, name, className = "" }: { src?: string | null; name: string; className?: string }) {
  ...
  return (
    <div className={`relative overflow-hidden flex items-center justify-center font-bold text-slate-600 dark:text-slate-300 bg-slate-700 ${className}`}>
      <span>{initials}</span>
      {src && (
        <img
          src={src}
...
function StatCard({ label, value, icon: Icon, color }: { label: string; value: string | number; icon: any; color: string }) {
  return (
    <div className={`bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-4 flex items-center gap-4`}>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="font-bold text-slate-900 dark:text-white text-sm leading-tight">{entry.name}</p>
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        {/* Tab switcher */}
        <div className="flex bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-1 gap-1">
      ...
      {data?.stats && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          />
          <div className="bg-white/5 backdrop-blur-md border border-slate-200 dark:border-white/10 rounded-2xl p-4 flex flex-col items-center justify-center min-h-[120px]">
            <div className="flex items-center gap-2 mb-3 text-violet-400">
              <Crown className="w-5 h-5" />
              <h3 className="text-xs font-semibold text-slate-600 dark:text-slate-300">Top Performer</h3>
            </div>
      ...
      {/* Leaderboard */}
      <div className="bg-white/5 backdrop-blur-md border border-slate-200 dark:border-white/10 rounded-3xl p-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium">No achievements recorded yet.</p>
