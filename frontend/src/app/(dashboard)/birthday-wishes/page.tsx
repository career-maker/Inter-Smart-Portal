        ...
        {isLoading ? (
          <div className="flex items-center justify-center min-h-96">
            <div className="text-center">
              ...
              <p className="text-slate-900 dark:text-white">Loading your wishes...</p>
            </div>
          </div>
        ) : wishes.length === 0 ? (
          <div className="flex items-center justify-center min-h-96">
            <div className="text-center">
              <Heart className="w-24 h-24 mx-auto text-slate-500 dark:text-slate-400 mb-4 animate-pulse" />
          ...
          <div className="px-6 pb-8">
            ...
            <div className="text-center mb-8">
              <span className="inline-block bg-white/20 backdrop-blur-sm text-slate-900 dark:text-white px-6 py-2 rounded-full font-semibold">
                ...
                >
                  ...
                  <div
                    className={`bg-gradient-to-br ${getColor(
                      index
                    )} rounded-lg shadow-xl p-6 min-h-72 relative transform transition-all duration-300 group-hover:shadow-2xl group-hover:scale-105 border-2 border-slate-200 dark:border-white/30`}
                    style={{
