...
export const PALETTE_PRESETS: PalettePreset[] = [
  ...
  },
  {
    ...
    tagline: "Neutral graphite slate with crisp sapphire blue brand action accents",
    category: "corporate",
    previewColors: ["#0F172A", "#1E293B", "#2563EB", "#38BDF8", "#F8FAFC"],
    settings: {
      ...
      border_color: "#E2E8F0",
      header_text_color: "#FFFFFF",
      sub_header_active_color: "#2563EB",
    },
  },
  // ─── Extended Palettes ───────────────────────────────────────────────────
  {
    id: "royal_navy",
    name: "Royal Navy",
    tagline: "Classic deep navy with bold indigo leadership accents",
    category: "corporate",
    previewColors: ["#0A0F2E", "#1E2A78", "#3B4FD4", "#6378F5", "#EEF0FF"],
    settings: {
      sidebar_bg_color: "#0A0F2E",
      sidebar_hover_color: "#1E2A78",
      sidebar_active_color: "#3B4FD4",
      header_bg_color: "#1E2A78",
      primary_color: "#3B4FD4",
      hover_color: "#6378F5",
      active_color: "#A5B4FC",
      dark_text_color: "#0A0F2E",
      light_bg_color: "#EEF0FF",
      card_bg_color: "#F8F9FF",
      border_color: "#C7D2FE",
      header_text_color: "#FFFFFF",
      sub_header_active_color: "#3B4FD4",
    },
  },
  {
    id: "sunset_coral",
    name: "Sunset Coral",
    tagline: "Warm energetic coral and terracotta with a lively modern feel",
    category: "warm",
    previewColors: ["#7C1D23", "#C0392B", "#E74C3C", "#F1948A", "#FEF5F4"],
    settings: {
      sidebar_bg_color: "#7C1D23",
      sidebar_hover_color: "#C0392B",
      sidebar_active_color: "#E74C3C",
      header_bg_color: "#C0392B",
      primary_color: "#E74C3C",
      hover_color: "#F1948A",
      active_color: "#FAB3AD",
      dark_text_color: "#7C1D23",
      light_bg_color: "#FEF5F4",
      card_bg_color: "#FFFBFB",
      border_color: "#FCCAC4",
      header_text_color: "#FFFFFF",
      sub_header_active_color: "#E74C3C",
    },
  },
  {
    id: "amber_gold",
    name: "Amber Gold",
    tagline: "Prestigious warm amber & honey tones with dark mahogany sidebar",
    category: "warm",
    previewColors: ["#451A03", "#92400E", "#D97706", "#FBBF24", "#FFFBEB"],
    settings: {
      sidebar_bg_color: "#451A03",
      sidebar_hover_color: "#92400E",
      sidebar_active_color: "#D97706",
      header_bg_color: "#92400E",
      primary_color: "#D97706",
      hover_color: "#FBBF24",
      active_color: "#FCD34D",
      dark_text_color: "#451A03",
      light_bg_color: "#FFFBEB",
      card_bg_color: "#FEFCE8",
      border_color: "#FDE68A",
      header_text_color: "#FFFFFF",
  ...
  },
  {
    id: "orchid_violet",
    name: "Orchid Violet",
    tagline: "Sophisticated purple-violet gradient with luxury velvet accents",
    category: "creative",
    previewColors: ["#2D0A4E", "#5B21B6", "#7C3AED", "#A78BFA", "#F5F3FF"],
    settings: {
      sidebar_bg_color: "#2D0A4E",
      sidebar_hover_color: "#5B21B6",
      sidebar_active_color: "#7C3AED",
      header_bg_color: "#5B21B6",
      primary_color: "#7C3AED",
      hover_color: "#A78BFA",
      active_color: "#C4B5FD",
      dark_text_color: "#2D0A4E",
      light_bg_color: "#F5F3FF",
      card_bg_color: "#FAF8FF",
      border_color: "#DDD6FE",
      header_text_color: "#FFFFFF",
      sub_header_active_color: "#7C3AED",
    },
  },
  {
    id: "rose_blush",
    name: "Rose Blush",
    tagline: "Elegant crimson rose with blush pastel backgrounds",
    category: "creative",
    previewColors: ["#881337", "#BE123C", "#F43F5E", "#FDA4AF", "#FFF1F2"],
    settings: {
      sidebar_bg_color: "#881337",
      sidebar_hover_color: "#BE123C",
      sidebar_active_color: "#F43F5E",
      header_bg_color: "#BE123C",
      primary_color: "#F43F5E",
      hover_color: "#FB7185",
      active_color: "#FDA4AF",
      dark_text_color: "#881337",
      light_bg_color: "#FFF1F2",
      card_bg_color: "#FFF5F6",
      border_color: "#FECDD3",
      header_text_color: "#FFFFFF",
      sub_header_active_color: "#F43F5E",
    },
  },
  {
    id: "midnight_graphite",
    name: "Midnight Graphite",
    tagline: "Ultra-dark charcoal with platinum and silver high-contrast tones",
    category: "corporate",
    previewColors: ["#030712", "#111827", "#374151", "#9CA3AF", "#F9FAFB"],
    settings: {
      sidebar_bg_color: "#030712",
      sidebar_hover_color: "#111827",
      sidebar_active_color: "#374151",
      header_bg_color: "#111827",
      primary_color: "#374151",
      hover_color: "#6B7280",
      active_color: "#9CA3AF",
      dark_text_color: "#030712",
      light_bg_color: "#F9FAFB",
      card_bg_color: "#FFFFFF",
      border_color: "#E5E7EB",
      header_text_color: "#FFFFFF",
      sub_header_active_color: "#6B7280",
    },
  },
  {
    id: "sky_cerulean",
    name: "Sky Cerulean",
    tagline: "Bright airy sky blue with crisp cloud-white surfaces",
    category: "corporate",
    previewColors: ["#0C4A6E", "#0369A1", "#0EA5E9", "#7DD3FC", "#F0F9FF"],
    settings: {
      sidebar_bg_color: "#0C4A6E",
      sidebar_hover_color: "#0369A1",
      sidebar_active_color: "#0EA5E9",
      header_bg_color: "#0369A1",
      primary_color: "#0EA5E9",
      hover_color: "#38BDF8",
      active_color: "#7DD3FC",
      dark_text_color: "#0C4A6E",
      light_bg_color: "#F0F9FF",
      card_bg_color: "#F8FAFF",
      border_color: "#BAE6FD",
      header_text_color: "#FFFFFF",
      sub_header_active_color: "#0EA5E9",
    },
  },
  {
    id: "jade_mint",
    name: "Jade Mint",
    tagline: "Crisp emerald mint tones for a fresh contemporary portal",
    category: "green_teal",
    previewColors: ["#065F46", "#059669", "#34D399", "#6EE7B7", "#ECFDF5"],
    settings: {
      sidebar_bg_color: "#065F46",
      sidebar_hover_color: "#059669",
      sidebar_active_color: "#34D399",
      header_bg_color: "#059669",
      primary_color: "#059669",
      hover_color: "#34D399",
      active_color: "#6EE7B7",
      dark_text_color: "#065F46",
      light_bg_color: "#ECFDF5",
      card_bg_color: "#F0FDF4",
      border_color: "#A7F3D0",
      header_text_color: "#FFFFFF",
      sub_header_active_color: "#34D399",
    },
  },
  {
    id: "copper_bronze",
    name: "Copper Bronze",
    tagline: "Warm copper metallic with burnished bronze sidebar depth",
    category: "warm",
    previewColors: ["#431407", "#7C2D12", "#C2410C", "#FB923C", "#FFF7ED"],
    settings: {
      sidebar_bg_color: "#431407",
      sidebar_hover_color: "#7C2D12",
      sidebar_active_color: "#C2410C",
      header_bg_color: "#7C2D12",
      primary_color: "#C2410C",
      hover_color: "#EA580C",
      active_color: "#FB923C",
      dark_text_color: "#431407",
      light_bg_color: "#FFF7ED",
      card_bg_color: "#FFFCF8",
      border_color: "#FED7AA",
      header_text_color: "#FFFFFF",
      sub_header_active_color: "#C2410C",
    },
  },
  {
    id: "neon_cyber",
    name: "Neon Cyber",
    tagline: "High-contrast cyberpunk black with electric neon teal pop",
    category: "creative",
    previewColors: ["#000000", "#0D1117", "#00D4AA", "#00FF87", "#F0FFF8"],
    settings: {
      sidebar_bg_color: "#000000",
      sidebar_hover_color: "#0D1117",
      sidebar_active_color: "#00D4AA",
      header_bg_color: "#0D1117",
      primary_color: "#00D4AA",
      hover_color: "#00FF87",
      active_color: "#7FFFD4",
      dark_text_color: "#000000",
      light_bg_color: "#F0FFF8",
      card_bg_color: "#F8FFFD",
      border_color: "#B2FFEC",
      header_text_color: "#00FF87",
      sub_header_active_color: "#00D4AA",
    },
  },
];
