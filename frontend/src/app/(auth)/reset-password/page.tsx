      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm shadow-2xl relative">
        ...
        {successMessage ? (
          <div className="space-y-5">
            ...
            <a
              href="/login"
              className="w-full py-3 px-4 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 font-bold rounded-xl transition flex items-center justify-center gap-2 text-sm cursor-pointer"
            >
              Sign In Now
            </a>
          </div>
...
export default function ResetPasswordPage() {
  return (
    <Suspense
      fallback={
        <div className="w-full max-w-md p-8 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center">
