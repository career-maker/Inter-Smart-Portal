...
class CustomTeamPermission extends Model
{
    ...
    public static function getDefinitions(): array
    {
        return [
            ...
            [
                'key' => 'bugzilla_viewer',
                'name' => 'bugSmart - Viewer',
                'description' => 'Allows viewing bugSmart projects, components, bugs, comments, attachments, history, and dependencies.',
                'category' => 'bugSmart Defect Management',
                'icon' => 'Eye',
            ],
            [
                'key' => 'bugzilla_reporter',
                'name' => 'bugSmart - Reporter',
