...
<head>
    ...
    <style type="text/css">
        * { margin: 0; padding: 0; }
        ...
        .section-title { font-size: 14px; font-weight: 600; color: #f97316; margin-top: 25px; margin-bottom: 15px; text-transform: uppercase; letter-spacing: 0.5px; }
        ...
        .status-box { background: #fff7ed; border-left: 4px solid #f97316; padding: 15px; border-radius: 4px; margin: 20px 0; font-size: 14px; }
        .status-box strong { color: #f97316; }
        ...
        .approval-note { background: #dbeafe; border-left: 4px solid #3b82f6; padding: 15px; border-radius: 4px; margin: 20px 0; font-size: 13px; line-height: 1.6; }
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>New Work From Home Request</h1>
            <p>Action Required</p>
        </div>
        ...
        <div class="content">
            ...
            <!-- WFH Details -->
            <div class="section-title">Work From Home Details</div>
            <table class="detail-table">
                <tr>
                    <td>Duration Type</td>
                    <td><strong>{{ $data['duration_type'] }}</strong></td>
                </tr>
            ...
            <div class="approval-note">
                <strong>ℹ️ Approval Process:</strong> This WFH request requires approval from both Team Lead and HR. Your approval will be recorded in the system.
            </div>

            <!-- Action Info -->
            <div class="info-box">
                <strong>ℹ️ Next Steps:</strong> Please review the request and approve or reject it from the HR Portal. Click the button below to proceed.
            </div>

            <!-- Action Button -->
            <div class="button-group">
                <a href="{{ $data['approvals_url'] }}?id={{ $data['request_id'] }}" class="button button-approve" style="color: white;">✓ Review & Respond</a>
            </div>

            <!-- Portal Link -->
            <p style="text-align: center; margin-top: 20px; font-size: 13px; color: #666;">
                <a href="{{ $data['portal_url'] }}" style="color: #f97316; text-decoration: none;">Open HR Portal</a>
            </p>
        </div>
