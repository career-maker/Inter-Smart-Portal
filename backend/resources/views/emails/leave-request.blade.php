...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                Hello {{ $leaveRequest->user->teamLead?->first_name ?? 'Team Lead' }},
            </div>

            <p style="margin-bottom: 15px; color: #666;">
                <strong>{{ $leaveRequest->user->first_name }} {{ $leaveRequest->user->last_name }}</strong> has submitted a leave request that requires your review.
            </p>
            ...
            <div class="application-form">
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <div class="form-value">{{ $leaveRequest->user->first_name }} {{ $leaveRequest->user->last_name }}</div>
                    </div>
                    <div class="form-field">
                        <span class="form-label">Employee ID</span>
                        <div class="form-value">{{ $leaveRequest->user->employee_code }}</div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <div class="form-value">{{ $leaveRequest->user->team?->name ?? 'N/A' }}</div>
                    </div>
                    <div class="form-field">
                        <span class="form-label">Designation</span>
                        <div class="form-value">{{ $leaveRequest->user->designation ?? 'N/A' }}</div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <div class="form-value">{{ $leaveRequest->leaveType->name }}</div>
                    </div>
                    <div class="form-field">
                        <span class="form-label">Number of Days</span>
                        <div class="form-value">{{ $leaveRequest->days_taken }} day(s)</div>
                    </div>
                </div>

                <div class="form-row">
                    <div class="form-field">
                        <span class="form-label">Leave Date(s)</span>
                    ...
                    <div class="form-field">
                        ...
                        <div class="form-value">{{ $leaveRequest->created_at->format('d M Y, h:i A') }}</div>
                    </div>
                </div>
                ...
                <div class="form-row full">
                    <div class="form-field">
                        ...
                        <div class="reason-box">{{ $leaveRequest->reason ?? 'No reason provided' }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="action-section">
                ...
                <div class="button-group">
                    <a href="{{ config('app.frontend_url') }}/approval/leave/{{ $leaveRequest->id }}?action=approve" class="btn btn-approve">✓ Approve</a>
                    <a href="{{ config('app.frontend_url') }}/approval/leave/{{ $leaveRequest->id }}?action=reject" class="btn btn-reject">✗ Reject</a>
                </div>
                <div class="reference-info">
                    Reference ID: <strong>#LR{{ str_pad($leaveRequest->id, 6, '0', STR_PAD_LEFT) }}</strong>
                </div>
            </div>
