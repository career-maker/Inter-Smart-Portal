...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <h1 class="header-title">Leave Request</h1>
        ...
        <div class="content">
            <div class="content-wrapper">
                ...
                <div class="status-box">
                    ...
                    <div class="status-text">A leave request requires your review</div>
                </div>
                ...
                <div style="margin-top: 30px;">
                    <div style="font-size: 13px; font-weight: 600; color: #6b7280; text-transform: uppercase; letter-spacing: 0.3px; margin-bottom: 15px;">Leave Details</div>
                    <div class="details-grid">
                        <div class="detail-item">
                            <div class="detail-label">Type</div>
                            <div class="detail-value"><strong>{{ $data['leave_type'] }}</strong></div>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value"><strong>{{ $data['days'] }}</strong></div>
                        </div>
                        <div class="detail-item">
                ...
                <div class="action-box">
                    ...
                    <div class="action-text">Please review the leave request and approve or reject it from the HR Portal.</div>
                </div>

                <!-- Action Buttons -->
                <div class="button-group">
                    <a href="{{ $data['approvals_url'] }}?id={{ $data['request_id'] }}" class="button button-approve">✓ Review & Approve</a>
                    <a href="{{ $data['approvals_url'] }}?id={{ $data['request_id'] }}" class="button button-reject">✗ Review & Reject</a>
                </div>
            </div>
        </div>
